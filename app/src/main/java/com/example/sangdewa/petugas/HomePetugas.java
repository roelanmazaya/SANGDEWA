...
public class HomePetugas extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.homepetugas);
...
//        tgl =  findViewById(R.id.tanggal_lahir);
        ...
        orderaktiff.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(HomePetugas.this, PetaPetugas.class));
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            }
        });
        order.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                finish();
                Intent intent = new Intent(getApplicationContext(), HomePetugas.class);
                startActivity(intent);
...
//        });
        ...
        notifikasi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(HomePetugas.this, Notif.class));
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            }
        });
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                System.out.println(data.getString("Foto"));
        ...
        builder.setMessage("Anda yakin ingin keluar?")
                ...
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(HomePetugas.this, Login.class));
                        finish();
...
//    Geocoder geocoder = new Geocoder(getActivity(), Locale.getDefault());
        Geocoder geocoder = new Geocoder(HomePetugas.this);
        try {
